...
class QemuParser:
    def __init__(self, config_provider: Callable[[], "QemuConfig"]): # type: ignore
        self.qemu_config: "QemuConfig" = config_provider() # type: ignore
        self._context = None  # contexto AppContext
